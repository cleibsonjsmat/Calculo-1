...
echo '        :root { --primary-green: #0f8b44; --primary-dark: #09592b; --bg-gray: #f8fafc; --card-bg: #ffffff; --text-main: #1e293b; --text-muted: #64748b; --border-color: #e2e8f0; }' >> "$HTML_FILE"
...
echo '        <h1>Prof. Cleibson Silva</h1>' >> "$HTML_FILE"
echo '        <p class="subtitle">Licenciatura em Matemática e Cursos Técnicos</p>' >> "$HTML_FILE"
...
echo '            <p>Selecione a disciplina abaixo para visualizar as listas de exercícios, roteiros e materiais didáticos em PDF.</p>' >> "$HTML_FILE"
echo '        </div>' >> "$HTML_FILE"
echo '        <div class="card">' >> "$HTML_FILE"
...
echo '        <p><strong>Instituto Federal de Pernambuco — Campus Caruaru</strong></p>' >> "$HTML_FILE"
echo '        <p>Desenvolvido com LaTeX & GitHub Pages</p>' >> "$HTML_FILE"
echo '    </footer>' >> "$HTML_FILE"
